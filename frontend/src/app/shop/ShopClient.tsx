...
export default function ShopClient({ initialCategories, initialProducts }: { initialCategories: any[], initialProducts: any[] }) {
  ...
  useEffect(() => {
    ...
    if (initialProducts && initialProducts.length > 0) {
      maxP = Math.max(...initialProducts.map((p: any) => p.price || 0));
    }
